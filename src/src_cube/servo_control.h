...
// Individual servo angle mappings based on your specifications
...
// Normalized control functions (0-180 range mapped to each servo's range)
void SetServo1Normalized(uint8_t normalized_angle);  // 0=open, 180=closed
...
void SetAllServosNormalized(uint8_t normalized_angle);  // Set all fingers together
